...
export default function CardLike({
  ...
  return (
    <div className="mt-2">
      ...
      {count === 0 && !msg && (
        <p className="flex items-start gap-1 text-[11px] text-[#7d9800] mt-1 leading-snug pl-[9px]">
          <span className="flex-none">🌟</span>
          <span>{t('like.be_first_short', "Soyez le premier à l'aimer !")}</span>
        </p>
      )}
      {msg && (
        <p className="flex items-start gap-1 text-[11px] text-[#f97316] mt-1 leading-snug pl-[9px]">
